...
<html>
    <head>
        ...
        <title>Sistema Ventas | Clientes</title>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree" style="margin-top: 20px;">
                        ...
                        <li class="active"><a href="Cliente?accion=li"><i class="fa fa-users"></i> <span>Clientes</span></a></li>
                        ...
                        <div class="modal fade" id="modalempleados">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="Cliente?accion=re" method="post" class="form">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input type="text" name="txtNombres" class="form-control" placeholder="Ronald Alejando Irigoin Nuñez">
                                                        </div>
                                                    </div>
                                                </div>                                               
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input type="text" maxlength="20" name="txtNumeroDoc" class="form-control" placeholder="78019778">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input type="text" name="txtDepartamento" class="form-control" placeholder="Lambayeque">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            <span class="input-group-addon"><i class="fa fa-flag"></i></span>
                                                            <input name="txtDistrito" type="text" class="form-control" placeholder="Chiclayo">
                                                        </div>
                                                    </div>
                                                </div>                                         
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input name="txtProvincia" type="text" class="form-control" placeholder="Chiclayo">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input name="txtDireccion" type="text" class="form-control" placeholder="Urb. San Lorenzo 435 - Jose Leonardo Ortiz">
                                                        </div>
                                                    </div>
                                                </div>                                                                 
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input name="txtCorreo" type="text" class="form-control" placeholder="ronald@gmail.com">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="chkVigencia" 
                                                               <c:out value="${cliente.estado == false ? 'unchecked' : 'checked'}"
                                                                      default="" />>Disponible
                                                    </label>
                                                </div>                                                
                                            </div>                                              
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" value="Registrar" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Guardar Registro</button>  
                                        </div>
                                    </form>
                                </div>
                                <!-- /.modal-content -->
