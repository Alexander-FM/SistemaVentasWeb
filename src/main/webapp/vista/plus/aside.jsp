<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree" style="margin-top: 20px;">
            ...
            <li class="active"><a href="../vista/inicio.jsp"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
            <li class="treeview">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="../vista/clientes.jsp"><i class="fa fa-users"></i> <span>Clientes</span></a></li>
