...
<html>
    <head>
        ...
        <title>Sistema Ventas | Categorias</title>
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-left">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#Categoria">
                                    <i class="fa fa-plus"></i> Nueva Categoria</button>     
                                    <c:if test="${msje != ''}">
                                    <div>${msje}</div>
                                </c:if>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Gestión Categorias</h4>
                                    </div>
                                    <form action="Categoria?accion=re" method="post" class="form">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            ...
                                                            <input name="Categoria" autofocus="" type="text" class="form-control" placeholder="Lacteos">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="chkVigencia" 
                                                               <c:out value="${categoria.estado == false ? 'unchecked' : 'checked'}"
                                                                      default="" />>Activo
                                                    </label>
                                                </div>                                                
                                            </div>  
